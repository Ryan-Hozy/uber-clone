...
const RideCard = ({
    ...
    //this view creates a card that contains the infos
    <View className="flex flex-row items-center justify-center bg-white rounded-lg 
    shadow-sm shadow-neutral-300 mb-3">
        <View className="flex flex-col items-center justify-between p-3">
            <View className="flex flex-row items-center justify-between">
                <Image 
                    // uri is used in React Native to provide a consistent, 
                    // platform-agnostic way to reference media resources, 
                    // especially when dealing with remote images.
            ...
            <View className="flex flex-col w-full mt-5 bg-general-500 rounded-lg p-3 items-start justify-center">
                ...
                <View className="flex flex-row items-center w-full justify-between mb-5">
                    ...
                    <Text className={`text-md capitalize font-JakartaMedium text-gray-500 
